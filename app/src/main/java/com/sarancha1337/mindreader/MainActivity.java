...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean isDeviceChoosed;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Switch isDC = findViewById(R.id.switch1);
        isDeviceChoosed = false;
        isDC.setChecked(isDeviceChoosed);

        isDC.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                isDeviceChoosed = isChecked;
                Button connectButton = findViewById(R.id.connectButton);
                connectButton.setEnabled((isDeviceChoosed || isBoth) && !deviceConnected);
            }
        });

        Switch isB = findViewById(R.id.switch2);
        isBoth = false;
        isB.setChecked(isDeviceChoosed);
        isB.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                isBoth = isChecked;
                Button connectButton = findViewById(R.id.connectButton);
        ...
        View.OnClickListener start = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fileChosen && sw.isChecked()) {
                    ...
                    //recreate();
                    System.exit(0);
                } else if (videoSet && (isDeviceChoosed || isBoth) && deviceConnected) {
